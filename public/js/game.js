...
class GameScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.physics.add.overlap(this.player, [this.fires, this.barrels], this.restartGame, undefined, this);
    ...
    setupLevel() {
        ...
        this.player = this.physics.add.sprite(this.levelData.player.x, this.levelData.player.y, 'player', 3);
